...
public class BookControllerTest {
    ...
    @MockBean
    private GLEDataRepository mockRepository;

    @Before
    public void init() {
        AccountDetails book = new AccountDetails(1L, "Book Name", "Mkyong", new BigDecimal("9.99"));
    ...
    public void find_allBook_OK() throws Exception {
        ...
        List<AccountDetails> books = Arrays.asList(
                new AccountDetails(1L, "Book A", "Ah Pig", new BigDecimal("1.99")),
                new AccountDetails(2L, "Book B", "Ah Dog", new BigDecimal("2.99")));
    ...
    public void save_book_OK() throws Exception {
        ...
        AccountDetails newBook = new AccountDetails(1L, "Spring Boot Guide", "mkyong", new BigDecimal("2.99"));
        when(mockRepository.save(any(AccountDetails.class))).thenReturn(newBook);
        ...
        verify(mockRepository, times(1)).save(any(AccountDetails.class));
    ...
    public void update_book_OK() throws Exception {
        ...
        AccountDetails updateBook = new AccountDetails(1L, "ABC", "mkyong", new BigDecimal("19.99"));
        when(mockRepository.save(any(AccountDetails.class))).thenReturn(updateBook);
    ...
    public void patch_bookAuthor_OK() throws Exception {
        ...
        when(mockRepository.save(any(AccountDetails.class))).thenReturn(new AccountDetails());
    ...
    public void patch_bookPrice_405() throws Exception {
        ...
        verify(mockRepository, times(1)).findById(1L);
        verify(mockRepository, times(0)).save(any(AccountDetails.class));
    }
